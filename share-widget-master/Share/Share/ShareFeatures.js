...
var ShareFeatures = /** @class */ (function (_super) {
    ...
    ], ShareFeatures.prototype, "copyToClipboard");
    __decorate([
        decorators_1.property({ value: true })
    ], ShareFeatures.prototype, "shareServices");
    __decorate([
        decorators_1.property()
    ], ShareFeatures.prototype, "embedMap");
    __decorate([
        decorators_1.property()
    ], ShareFeatures.prototype, "shortenLink");
    ShareFeatures = __decorate([
        decorators_1.subclass("ShareFeatures")
    ], ShareFeatures);
    return ShareFeatures;
}(decorators_1.declared(Accessor)));
module.exports = ShareFeatures;
