...
var Collection = require("esri/core/Collection");
// esri.core.accessorSupport
var decorators_1 = require("esri/core/accessorSupport/decorators");
//esri.geometry
var Point = require("esri/geometry/Point");
// esri.request
var esriRequest = require("esri/request");
// Share Item
var ShareItem = require("./ShareItem");
// Share Feature
var ShareFeatures = require("./ShareFeatures");
// esri.geometry
var projection = require("esri/geometry/projection");
var SpatialReference = require("esri/geometry/SpatialReference");
//----------------------------------
//
...
var ShareViewModel = /** @class */ (function (_super) {
    ...
    ], ShareViewModel.prototype, "state");
    __decorate([
        decorators_1.property({
            dependsOn: ["shareUrl"],
            readOnly: true
        })
    ], ShareViewModel.prototype, "embedCode");
    __decorate([
        decorators_1.property()
    ], ShareViewModel.prototype, "view");
    __decorate([
        decorators_1.property()
    ], ShareViewModel.prototype, "shareModalOpened");
    __decorate([
        decorators_1.property({
            type: ShareItemCollection
        })
    ], ShareViewModel.prototype, "shareItems");
    __decorate([
        decorators_1.property({
            type: ShareFeatures
        })
    ], ShareViewModel.prototype, "shareFeatures");
    __decorate([
        decorators_1.property({ readOnly: true })
    ], ShareViewModel.prototype, "shareUrl");
    ShareViewModel = __decorate([
        decorators_1.subclass("ShareViewModel")
    ], ShareViewModel);
    return ShareViewModel;
}(decorators_1.declared(Accessor)));
module.exports = ShareViewModel;
